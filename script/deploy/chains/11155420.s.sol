...
import {DeployOptimismReceiverModule} from "../modules/messaging/receiver/DeployOptimismReceiverModule.s.sol";
...
contract Deploy is Script {
    function run() external returns (address satelliteAddress) {
        ...
        deployModules[8] = new DeployOptimismReceiverModule();
